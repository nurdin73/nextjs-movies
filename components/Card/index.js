        ...
        <Link href={link}>
            <li className="cursor-pointer shadow-sm">
                <div className="relative overflow-hidden group rounded">
                    ...
                    <div className="absolute transition duration-300 transform md:translate-y-12 group-hover:translate-y-0 left-0 right-0 -bottom-0 px-1 py-1 lg:bg-gray-900 bg-gray-800 text-white">
