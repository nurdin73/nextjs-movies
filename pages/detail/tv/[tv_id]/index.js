...
export async function getServerSideProps(context) {  
    ...
    const api = await fetch(`https://api.themoviedb.org/3/tv/${tvId}?api_key=${process.env.API_KEY}&append_to_response=credits,keywords,videos,images,reviews,release_dates,external_ids`)
