...
function Watchlists() {  
    ...
    const handlePaginate = (pageNumber = 1) => () => {
        ...
        getData(`https://api.themoviedb.org/3/account/${account.id}/watchlist/${tab}?api_key=${process.env.API_KEY}&session_id=${session}&sort_by=created_at.desc&page=${pageNumber}`)
    }
